...
public partial class Mask : Node2D
{
	...
	[Export] public float CollisionBoxRadius = 50f;
	...
	public void SetMask(MaskEnum mask)
	{
		...
		switch (collisionShape.Shape)
		{
			case CircleShape2D circle:
				circle.Radius = CollisionBoxRadius;
				break;

			case RectangleShape2D rect:
				rect.Size = new Vector2(CollisionBoxRadius * 2, CollisionBoxRadius * 2);
				break;
			...
			case ConvexPolygonShape2D polygon:
				...
				{
					points[i] = points[i].Normalized() * CollisionBoxRadius;
				}
